...
int main(int argc, char** argv){
    ...
    std::string trace_file = ""; // Blank by default to force user input
	//==========================================================================//
	...
	for (int i = 1; i < argc; i++) {
        ...
        // Parse Integer Arguments (using std::stoull to convert string to uint64_t)
